    ...
    <section className="section-padding bg-muted relative overflow-hidden">
      ...
      <div className="container-wide relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group flex items-start gap-4 p-6 bg-white border-2 border-border rounded-2xl hover:border-[#F3CD45] hover:shadow-lg transition-all duration-300"
            >
        ...
        <motion.div
          ...
          className="bg-white border-2 border-[#F3CD45] rounded-3xl p-8 md:p-12 relative overflow-hidden"
        >
