...
const testimonials = [
  {
    ...
    content: "Primer Group replaced the entire roof on our 50,000 sq ft warehouse. Professional team, minimal disruption to our operations, and completed ahead of schedule. Highly recommend.",
    rating: 5,
  },
  {
    name: "Sarah Mitchell",
    ...
    content: "We've used Primer Group for all our commercial properties across Merseyside for the past 8 years. Their maintenance program has saved us thousands in potential repairs.",
    rating: 5,
  },
  {
    name: "James O'Connor",
    ...
    content: "Emergency leak on a Sunday morning - Primer Group had a team on-site within 2 hours. Temporary fix done same day, permanent repair completed that week. Exceptional service.",
    rating: 5,
  },
  {
    name: "Helen Price",
    ...
    content: "Primer Group handled our hospital roof refurbishment with incredible attention to safety and cleanliness. Their team understood the sensitive nature of our environment.",
    rating: 5,
  },
];
      ...
      <div className="container-wide relative">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Over 35 years of delivering exceptional commercial roofing solutions. 
        ...
        >
          <div className="inline-flex items-center gap-3 bg-white border-2 border-border rounded-full px-6 py-3">
            ...
            <span className="text-foreground font-medium">
              500+ satisfied commercial clients
            </span>
